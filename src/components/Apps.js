...
function Apps(){
    return(
    <>
    <div className="h-full flex flex-col justify-center items-center space-y-10 overflow-auto py-14">
        <div className="justify-center items-center flex">
          <div className="flex-col">
            <p className="flex justify-center text-xl">Apps</p>
            <p className="flex justify-center text-4xl font-semibold">Used Technologies</p>
          </div>
        </div>
        <div className="flex flex-wrap lg:flex-nowrap lg:space-x-8 text-slate-600">
